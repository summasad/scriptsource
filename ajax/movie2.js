  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      movies.forEach((box) => {
        ...
        //"<p>" + box.rank + "위(" + rankInten + ") : " + box.movieNm + box.openDt + box.audiCnt + box.audiAcc+"</p>"
        str += "<tr><td>" + box.rank + "위" + "</td>";
        str += "<td>(" + rankInten + ")</td>";
        str += "<td>" + box.movieNm + "</td>";
        str += "<td>" + box.openDt + "</td>";
        str += "<td>" + box.audiCnt + "</td>";
        str += "<td>" + box.audiAcc + "</td></tr>";
      });
